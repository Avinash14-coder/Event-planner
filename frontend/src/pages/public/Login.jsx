...
const Login = ({ onLogin }) => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center p-4 dark:from-[#231018] dark:via-[#471f30] dark:to-[#6a2f49] bg-gradient-to-br from-[#6a2f49] via-[#b14e79] to-[#e0b8c9] animate-gradient-xy transition-colors duration-500">
      
      {/* GLASSMORPHISM CARD */}
      <div className="dark:bg-[#0a0d14]/90 bg-white/90 backdrop-blur-xl shadow-2xl rounded-3xl w-full max-w-lg overflow-hidden border dark:border-white/10 border-white/50 relative">
        ...
        <div className="p-8 md:p-12">
          ...
          {/* Role Tabs */}
          <div className="flex dark:bg-[#111622] bg-gray-100 p-1 rounded-xl mb-8 transition-colors">
              ...
              <button 
                ...
                className={`flex-1 py-2 capitalize font-bold rounded-lg transition-all duration-300 text-sm ${
                  activeTab === role 
                    ...
                    ? 'dark:bg-[#05070a] bg-white text-[#8e3e61] shadow-md transform scale-105' 
            ...
            {!isLoginMode && (
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 p-3.5 dark:bg-[#05070a] bg-gray-50 border dark:border-white/10 border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#b14e79] focus:bg-white dark:focus:bg-[#111622] dark:text-white text-gray-900 transition" 
                />
              </div>
            )}
            <div className="relative group">
