        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 text-center md:text-left">
          <div className="col-span-1 sm:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm mx-auto md:mx-0">
              Your one-stop destination for planning the perfect wedding,
              corporate event, or birthday party. We connect you with the best
              vendors in Nashik.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                <a
                  href="/"
                  className="hover:text-[#b14e79] transition block py-1"
                >
                  Home
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-center justify-center md:justify-start gap-2">
                <MapPin size={16} /> Nashik, Maharashtra
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
            ...
            <div className="flex gap-4 mt-6 justify-center md:justify-start">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#b14e79] transition hover:-translate-y-1"
              >
                <Facebook size={18} />
              </a>
              <a
