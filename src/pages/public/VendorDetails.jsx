      ...
      <div className="h-[400px] w-full relative bg-gray-900">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 text-white">
           <div className="container mx-auto">
             <span className="bg-purple-600 text-white px-3 py-1 rounded text-sm font-bold uppercase tracking-wide mb-3 inline-block shadow-lg">
               {vendor.type}
             </span>
             <h1 className="text-4xl md:text-5xl font-bold mb-3 drop-shadow-lg">{vendor.name}</h1>
             <div className="flex flex-wrap items-center gap-4 text-lg opacity-90">
               <span className="flex items-center gap-1"><MapPin size={20} /> {vendor.location}</span>
               <span className="flex items-center gap-1 text-yellow-400 font-bold"><Star size={20} fill="currentColor" /> {vendor.rating || 4.5} (24 Reviews)</span>
             </div>
           </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-10 grid md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-purple-100 sticky top-24">
            ...
            <button className="w-full bg-purple-600 text-white font-bold py-4 rounded-xl hover:bg-purple-700 transition mb-4 shadow-lg shadow-purple-200">
              Book Now
            </button>
