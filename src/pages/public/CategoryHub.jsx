...
const CategoryHub = () => {
  ...
  // Dynamic Data mapping based on reference images
  const hubConfig = {
    birthday: {
    ...
    wedding: {
      ...
      subs: [
        ...
        { title: "Bridal Makeup", img: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?q=80&w=600", type: "Makeup" },
        { title: "Wedding Planners", img: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=600", type: "Planner" }
      ]
    }
    // Add other categories (DJ, Reception, etc.) here following the same structure
  };

  const current = hubConfig[categoryName?.toLowerCase()] || hubConfig.birthday;
